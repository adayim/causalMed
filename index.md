...
[`mediation()`](https://adayim.github.io/causalMed/reference/mediation.md)
detects this pattern, warns at run time, and restates the caveat under
the decomposition when you
[`print()`](https://rdrr.io/r/base/print.html) the result; use
`mediation_type = "I"` in that setting.
